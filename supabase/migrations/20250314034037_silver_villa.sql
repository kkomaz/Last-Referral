/*
  # Add color scheme to profiles and update RPC function
  
  1. Changes
    - Add color scheme columns to profiles table
    - Drop existing update_profile functions
    - Create new version with color scheme support
...
-- Create new version of update_profile with all parameters
