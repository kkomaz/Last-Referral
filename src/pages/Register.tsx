        ...
        <header className="bg-white border-b border-gray-200 py-4">
          <div className="container mx-auto px-4 flex items-center">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-[#2b2d42]">ReferralTree</span>
            </Link>
          </div>
        </header>

        <div className="flex-grow flex items-center justify-center p-4">
          <UsernameRegistration onComplete={handleUsernameComplete} standalone={false} />
        </div>
      ...
      <div className="flex-grow flex items-center justify-center p-4">
        <div className="bg-white p-8 rounded-lg shadow-md max-w-md w-full">
          <h1 className="text-2xl font-bold text-center text-[#2b2d42] mb-6">
            Create Your ReferralTree
          </h1>
          
          <p className="text-gray-600 text-center mb-8">
            Join thousands of creators sharing their favorite products and earning rewards.
          </p>
